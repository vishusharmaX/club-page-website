    ...
    return (
        <footer style={footerStyle}>
            <div style={contactStyle}>
                ...
                <div>
                    <p><FaPhone style={{ marginRight: '5px', fontSize: '24px', color: 'white' }} /> +91 93408 49221</p>
                    <p><FaEnvelope style={{ marginRight: '5px', fontSize: '24px', color: 'white' }} /> vitbhopalcyberwarriors@gmail.com</p>
                </div>
            </div>
            ...
            <div style={madeWithLoveStyle}>
                Made with <span style={{ color: 'red', fontSize: '27px', width: '20px' }}>&hearts;</span> by CyberWarrior Club
            </div>
        </footer>
    );
};
